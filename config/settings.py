...
- pjecz_perseo_api_key_db_host
- pjecz_perseo_api_key_db_port
- pjecz_perseo_api_key_db_name
- pjecz_perseo_api_key_db_user
- pjecz_perseo_api_key_db_pass
- pjecz_perseo_api_key_origins
- pjecz_perseo_api_key_salt
...
SERVICE_PREFIX = os.getenv("SERVICE_PREFIX", "pjecz_perseo_api_key")
